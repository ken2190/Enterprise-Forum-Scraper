...
class MajesticGardenParser:
    def __init__(self, parser_name, files, output_folder, folder_path):
        # locale.setlocale(locale.LC_TIME, 'ru_RU.UTF-8')
        self.parser_name = "majestic_garden"
    ...
    def get_date(self, tag):
        date_block = tag.xpath(
                './/div[@class="postarea"]//div[@class="keyinfo"]//div[@class="smalltext"]/text()[2]'
            )[0].split("»")[0]
    ...
    def get_avatar(self, tag):
        ...
        if not avatar_block:
            ...
            return avatar_block[0].split("/")[3].split("type")[0]
