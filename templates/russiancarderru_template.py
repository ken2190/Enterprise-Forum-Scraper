...
class RussiancarderRuParser(BaseTemplate):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.parser_name = "russiancarder.ru"
        ...
        self.post_text_xpath = './/div[contains(@class,"message-content")]' \
                               '//article/descendant::text()[not(ancestor::div[contains(@class,"bbCodeQuote")])]'
