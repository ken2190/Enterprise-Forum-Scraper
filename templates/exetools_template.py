...
class ExetoolsParser(BaseTemplate):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.parser_name = "forum.exetools.com"
        ...
        self.date_xpath = 'tr//td[@class="thead"]/div[2]//text()'
        ...
        self.comment_block_xpath = 'tr//td[@class="thead"]/div[1]//text()'
    ...
    def get_comment_id(self, tag):
        ...
        match = pattern.findall(comment_block.strip())
        if not match:
            return
