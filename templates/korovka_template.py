...
class KorovkaParser(BaseTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.date_xpath = 'tr//td/a[contains(@name, "post")]/following-sibling::text()'
        self.date_pattern = '%d.%m.%Y, %H:%M'
        self.title_xpath = '//td[@class="navbar"]/a/following-sibling::strong[1]/text()'
        self.post_text_xpath = 'tr//div[contains(@id, "post_message_")]/div[@class="pmessage"]/descendant::text()[not(ancestor::div[@style="margin:20px; margin-top:5px; "])]'
        self.avatar_xpath = 'tr//a[contains(@href, "member.php?u=") and img/@src]/@href'
        self.avatar_ext = 'jpg'
        self.comment_block_xpath = 'tr//td/a[contains(@id, "postcount")]/strong/text()'
