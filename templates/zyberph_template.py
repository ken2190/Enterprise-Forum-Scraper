...
class ZyberphParser(BaseTemplate):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # locale.setlocale(locale.LC_TIME, 'ru_RU.UTF-8')
        self.parser_name = "zyberph.com"
        ...
        self.date_xpath = './/p[@class="author"]/text()'
        self.author_xpath = './/dl[@class="postprofile"]/dt/a/text()'
        self.title_xpath = '//div[@id="page-body"]/h2/a/text()'
        self.post_text_xpath = 'div//div[@class="content"]/text()'
        self.avatar_xpath = './/div[@class="author-container"]//img/@src'
