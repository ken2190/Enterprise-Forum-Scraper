...
class SinfulSiteParser:
    ...
    def extract_comments(self, html_response):
        ...
        comment_blocks = html_response.xpath(
          '//div[contains(@class,"anchor post")]'
        )
    ...
    def get_author(self, tag):
        author_block = tag.xpath(
            './/div[contains(@class,"authorbit")]/div[3]//text()'
        )
        author = "".join([
    ...
    def get_post_text(self, tag):
        post_text_block = tag.xpath(
            './/div[contains(@class,"textcontent") or contains(@class,"post_body")]//descendant::text()[not(ancestor::div[@class="hidelock"])]'
        )
        post_text = "".join([
    ...
    def get_comment_id(self, tag):
        ...
        comment_block = tag.xpath(
            './/div[@class="time fullwidth"]/div[1]/a/text()'
        )
