...
class HackThisSiteParser(BaseTemplate):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # locale.setlocale(locale.LC_TIME, 'ru_RU.UTF-8')
        self.parser_name = "hackthissite.org"
        ...
        self.date_xpath = './/p[@class="author"]/text()[2]'
        ...
        self.avatar_xpath = './/dl[@class="postprofile"]/dd[1]/img/@src'
    ...
    def get_date(self, tag):
        date_block = tag.xpath(self.date_xpath)[0].split('on')[-1]
