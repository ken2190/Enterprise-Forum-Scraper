...
class MfdParser:
    ...
    def get_date(self, tag):
        date_block = tag.xpath(
                './/div[@class="mfd-post-top-1"]/a/text()'
            )
    ...
    def get_avatar(self, tag):
        avatar_block = tag.xpath(
            './/div[@class="mfd-post-avatar"]//img/@src'
        )
        if not avatar_block:
            return ""
