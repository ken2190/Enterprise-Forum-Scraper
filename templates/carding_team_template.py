...
class CardingTeamParser:
    ...
    def get_date(self, tag):
        date_block = tag.xpath(
            'div//span[@class="post_date2"]/text()'
        )
    ...
    def get_author(self, tag):
        author = tag.xpath(
            'div//strong/span[@class="largetext"]/a/text()'
        )
        if not author:
            author = tag.xpath(
                'div//strong/span[@class="largetext"]/a/span/strong/text()'
            )
    ...
    def get_comment_id(self, tag):
        ...
        comment_block = tag.xpath(
            'div//div[@class="float_right"]/strong/a/text()'
        )
        # print(comment_block)
        if comment_block:
