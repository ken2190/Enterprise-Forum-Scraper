...
class SinisterParser:
    ...
    def get_date(self, tag):
        date = tag.xpath(
            'div//span[@class="post_date postbit_date"]/text()'
        )
    ...
    def get_author(self, tag):
        author = tag.xpath(
            'div//span[@class="largetext postbit_username"]/a/span/text()'
        )
    ...
    def get_avatar(self, tag):
        avatar_block = tag.xpath(
            'div//div[@class="author_avatar postbit_avatar"]'
            '/a/img/@src'
        )
        if not avatar_block:
            return ""
    ...
    def get_comment_id(self, tag):
        ...
        comment_block = tag.xpath(
            'div//span[@class="post_date postbit_date"]'
