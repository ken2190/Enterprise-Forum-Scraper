...
class PrimeForumsParser(BaseTemplate):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.parser_name = "primeforums.net"
        ...
        self.date_xpath = 'div//header[@class="message-attribution"]/a/time/@data-time'
        ...
        self.comment_block_xpath = 'div//div[@class="message-attribution-opposite"]/a/text()'
