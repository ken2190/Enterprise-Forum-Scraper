...
class AltenensParser:
    ...
    def get_post_text(self, tag):
        post_text_block = tag.xpath(            
            './/article[contains(@class,"selectToQuote")]/descendant::text()[not(ancestor::blockquote)]'
        )
    ...
    def get_comment_id(self, tag):
        ...
        comment_block = tag.xpath(
            ...
            './/ul[contains(@class,"message-attribution-opposite")]/li/a//text()'
        )
