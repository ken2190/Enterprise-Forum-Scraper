...
class SecurityLabParser:
    ...
    def extract_comments(self, html_response):
        ...
        comment_blocks = html_response.xpath(
          '//table[contains(@class,"forum-post-table")]'
        )
    ...
    def get_date(self, tag):
        date_block = tag.xpath(
            './/div[contains(@class,"forum-post-date")]/span/text()'
        )
    ...
    def get_author(self, tag):
        author = tag.xpath(
            './/div[contains(@class,"forum-user-name")]/span/text()'
        )
    ...
    def get_title(self, tag):
        title = tag.xpath(
            '//div[contains(@class,"forum-header-title")]//span//text()'
        )
        title = ''.join(title)
    ...
    def get_post_text(self, tag):
        post_text_block = tag.xpath(
            './/div[contains(@class,"forum-post-text")]//text()[not(ancestor::table[@class="forum-quote"])]'
        )
        post_text = " ".join([
    ...
    def get_comment_id(self, tag):
        ...
        comment_block = tag.xpath(
            './/div[contains(@class,"forum-post-number")]//a/text()'
        )
