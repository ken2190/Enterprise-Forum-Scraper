...
class SoqorParser:
    ...
    def extract_comments(self, html_response):
        ...
        comment_blocks = html_response.xpath(
          '//ul[contains(@class,"conversation-list")]/li[contains(@class,"b-post")]'
        )
    ...
    def get_date(self, tag):
        ...
        date_block = tag.xpath(
            './/div[contains(@class,"post__timestamp")]/time/@datetime'
        )
        if date_block:
    ...
    def get_author(self, tag):
        author = tag.xpath(
            # './/div[contains(@class,"userinfo")]/div[contains(@class,"author")]//text()'
            './/a[contains(@class,"b-avatar")]/img/@title'
        )
        author = ''.join(author)
    ...
    def get_title(self, tag):
        title = tag.xpath(
            '//h2[contains(@class,"b-post__title")]/text()'
        )
    ...
    def get_post_text(self, tag):
        ...
        './/div[contains(@class,"js-post__content-text")]//text()[not(ancestor::div[contains(@class,"bbcode_container")])]'
        )
        post_text = " ".join([
    ...
    def get_avatar(self, tag):
        avatar_block = tag.xpath(
            './/a[contains(@class,"b-avatar")]/img/@src'
        )
        if not avatar_block:
            return ""
    ...
    def get_comment_id(self, tag):
        ...
        comment_block = tag.xpath(
            './/a[contains(@class,"post__count")]/text()'
        )
        # print(comment_block)
        if comment_block:
