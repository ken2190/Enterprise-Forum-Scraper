...
class ox00secParser(BaseTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.files = self.get_filtered_files(*args, **kwargs)
        self.index = 1
        self.mode = 'r'
        self.comments_xpath = '//div[@class="topic-body crawler-post"]'
        self.header_xpath = '//div[@class="topic-body crawler-post"]'
