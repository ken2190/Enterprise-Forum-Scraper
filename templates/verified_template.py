...
class VerifiedParser:
    ...
    def extract_comments(self, html_response):
        ...
        comment_blocks = html_response.xpath(
          '//table[contains(@id, "post") and tr[@valign="top"]]'
        )
    ...
    def get_author(self, tag):
        author = tag.xpath(
            'tr//div[contains(@id, "postmenu_")]/a/font/b/text()'
        )
        if not author:
            author = tag.xpath(
    ...
    def get_post_text(self, tag):
        post_text = tag.xpath(
            'tr//div[contains(@id, "post_message_")]/font/text()'
        )
    ...
    def get_avatar(self, tag):
        avatar_block = tag.xpath(
            'tr//div[@class="smallfont"]/a/img/@src'
        )
        if not avatar_block:
            return ""
