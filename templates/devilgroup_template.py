...
class DevilGroupParser:
    ...
    def get_date(self, tag):
        date_block = tag.xpath(
                './/p[@class="ipsType_reset"]/a/time/text()'
            )
    ...
    def get_title(self, tag):
        title = tag.xpath(
            '//h1[contains(@class,"ipsType_pageTitle")]//span/text()'
        )
    ...
    def get_post_text(self, tag):
        post_text_block = tag.xpath(
               './/div[@class="cPost_contentWrap ipsPad"]//descendant::text()'
        )
        post_text = " ".join([
    ...
    def get_avatar(self, tag):
        avatar_block = tag.xpath(
            './/li[@class="cAuthorPane_photo"]//img/@src'
        )
        if not avatar_block:
            return ""
