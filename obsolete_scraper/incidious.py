...
class InsidiousSpider(SitemapSpider):
    name = 'insidious_spider'

    # Url stuffs
    base_url = "https://forum.insidious.ru/"
...
class InsidiousScrapper(SiteMapScrapper):

    spider_class = InsidiousSpider
    site_name = 'insidious.ru'
