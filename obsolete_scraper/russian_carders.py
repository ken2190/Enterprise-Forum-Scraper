...
class RussianCarderScrapper(BaseScrapper):
    def __init__(self, kwargs):
        super(RussianCarderScrapper, self).__init__(kwargs)
        self.base_url = 'https://russiancarders.se/'
    ...
    def do_scrape(self):
        print('************  RussianCarderScrapper Started  ************\n')
...
def main():
    template = RussianCarderScrapper()
    template.do_scrape()
