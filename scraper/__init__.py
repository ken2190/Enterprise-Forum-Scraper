...
from scraper.pastebin import PasteBinScrapper
...
from scraper.korovka_new import KorovkaNewScrapper
...
from scraper.phienbanmoi import PhienbanmoiScrapper
...
from scraper.vbiran import VBIranScrapper
...
SCRAPER_MAP = {
    ...
    'ccrackingorg': CCrackingOrgScrapper,
