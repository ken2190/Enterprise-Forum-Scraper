...
class CrackXSpider(scrapy.Spider):
    name = 'crackx_spider'

    def __init__(self, output_path, avatar_path):
        self.base_url = "https://crackx.to/"
        self.avatar_name_pattern = re.compile(r'.*/(\S+\.\w+)')
        self.pagination_pattern = re.compile(r'.*page=(\d+)')
        self.start_url = 'https://crackx.to/'
        self.output_path = output_path
        self.avatar_path = avatar_path
        self.headers = {
            'referer': 'https://crackx.to/',
    ...
    def parse(self, response):
        forums = response.xpath(
            '//div[@class="flex-grow"]/div/a[contains(@href, "Forum-")]')
        for forum in forums:
        ...
        sub_forums = response.xpath(
            '//div[@class="forum-subforums" and @id]'
...
class CrackXScrapper():
    ...
    def do_scrape(self):
        ...
        process.crawl(CrackXSpider, self.output_path, self.avatar_path)
        process.start()
