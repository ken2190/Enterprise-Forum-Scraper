...
class HoxForumSpider(scrapy.Spider):
    name = 'hoxforum_spider'

    def __init__(self, output_path, avatar_path):
        self.base_url = "http://hoxforum.com/"
        self.avatar_name_pattern = re.compile(r'.*/(\S+\.\w+)')
        self.pagination_pattern = re.compile(r'.*page=(\d+)')
        self.start_url = 'http://hoxforum.com/'
    ...
    def parse(self, response):
        forums = response.xpath(
            '//td[@valign]/strong/a[contains(@href, "Forum-")]')
        for forum in forums:
        ...
        sub_forums = response.xpath(
            '//strong[text()="Sub Forums:"]/'
            'following-sibling::a[contains(@href, "Forum-")]'
            )
...
class HoxForumScrapper():
    ...
    def do_scrape(self):
        ...
        process.crawl(HoxForumSpider, self.output_path, self.avatar_path)
        process.start()
