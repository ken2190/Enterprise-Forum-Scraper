...
class KilosSpider(MarketPlaceSpider):

    name = "hydramarket_spider"

    # Url stuffs
    base_url = "http://dnmugu4755642434.onion"

    # xpath stuffs
    login_form_xpath = '//form[contains(@action, "/login")]'
    captch_form_xpath = '//form[contains(@action, "/captcha")]'
    captcha_url_xpath = '//div[@class="callout"]/img/@src'
...
class KilosScrapper(SiteMapScrapper):
    spider_class = KilosSpider
    site_name = 'kilos'
