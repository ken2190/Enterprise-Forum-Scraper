...
class LeakPortalSpider(scrapy.Spider):
    name = 'leakportal_spider'

    def __init__(self, output_path, avatar_path):
        self.base_url = "https://www.leakportal.com/"
        self.topic_pattern = re.compile(r'topic/(\d+)-')
        self.avatar_name_pattern = re.compile(r'.*/(\S+\.\w+)')
        self.pagination_pattern = re.compile(r'.*/page/(\d+)/')
        self.start_url = 'https://www.leakportal.com/'
    ...
    def parse_thread(self, response):
        ...
        avatars = response.xpath('//li[@class="cAuthorPane_photo"]/img')
...
class LeakPortalScrapper():
    ...
    def do_scrape(self):
        ...
        process.crawl(LeakPortalSpider, self.output_path, self.avatar_path)
        process.start()
