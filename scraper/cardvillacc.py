...
class CardVillaCCSpider(SitemapSpider):
    name = 'cardvillacc_spider'
    base_url = 'https://cardvilla.cc/'
...
class CardVillaCCScrapper(SiteMapScrapper):

    spider_class = CardVillaCCSpider
    site_name = 'cardvilla.cc'
    site_type = 'forum'
