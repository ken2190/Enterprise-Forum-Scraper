...
class PrimeForumsSpider(scrapy.Spider):
    name = 'primeforums_spider'

    def __init__(self, output_path, avatar_path):
        self.base_url = "https://www.primeforums.net"
        self.topic_pattern = re.compile(r'threads/.*\.(\d+)/')
        self.avatar_name_pattern = re.compile(r'.*/(\S+\.\w+)')
        self.pagination_pattern = re.compile(r'.*page-(\d+)')
        self.start_url = 'https://www.primeforums.net'
        self.output_path = output_path
        self.avatar_path = avatar_path
        self.headers = {
            'referer': 'https://www.primeforums.net',
...
class PrimeForumsScrapper():
    ...
    def do_scrape(self):
        ...
        process.crawl(PrimeForumsSpider, self.output_path, self.avatar_path)
        process.start()
