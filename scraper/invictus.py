...
class InvictusSpider(MarketPlaceSpider):

    name = "invictus_spider"

    # Url stuffs
    base_url = "http://invicus3w24e22upa4scshje3e5rxqjjv4hf7l7p6lckzkukylsewwid.onion"

    # xpath stuffs
    captch_form_xpath = '//form[@method="post"]'
    captcha_url = '//div[contains(@class, "captcha_diff")]//img/@src'
...
class InvictusScrapper(SiteMapScrapper):
    spider_class = InvictusSpider
    site_name = 'invictus'
