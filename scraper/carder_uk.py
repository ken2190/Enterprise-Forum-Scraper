...
class CarderUKSpider(SitemapSpider):
    name = 'carder_uk_spider'

    # Url stuffs
    base_url = "https://carder.uk"
    forum_url = "https://carder.uk"
    login_url = "https://carder.uk/login/login"
...
class CarderUKScrapper(SiteMapScrapper):
    spider_class = CarderUKSpider
    site_name = 'carder.uk'
    site_type = 'forum'
